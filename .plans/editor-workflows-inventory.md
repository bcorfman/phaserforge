# Editor Workflows Inventory (Current Editor)

This document inventories the workflows currently exposed by the editor UI and gestures in the live codebase.

It follows the original rule: identify the smallest reusable workflows first, then reference them from larger workflows. It also calls out duplicate/redundant paths and missing workflows.
